...
docker run --cpuset-cpus="1,2" --memory="8g" --net Paxos_Network2 --ip=${MIP} -p 7087:7087 -e TYPE="master" -e MADDR=${MIP} -e MPORT=7087 -e NREPLICAS=5 --name ${MASTERNAME} ${MASTERNAME}